...
export function KeyFeatures() {
  const features = [
    {
      title: "Predictions",
      description: "Our advanced ML algorithms analyze your sleep patterns and predict your sleep quality based on personal metrics and habits.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description: "Get personalized recommendations to improve your sleep habits based on your unique patterns and academic schedule.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      title: "Dashboard",
      description: "Visualize your sleep patterns and academic performance in an intuitive dashboard with detailed analytics and insights.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      title: "Goal Tracker",
      description: "Set and track your sleep goals to continuously improve your sleep quality and monitor your progress over time.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      title: "Music",
      description: "Access a library of calming sounds and music to help you fall asleep faster and improve your overall sleep quality.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
